 ...
 */
public class RhxthmLayout extends HorizontalScrollView {
     ...
     * 适配器
     */
    private RhxthmAdapter mAdapter;
    /**
    ...
    public RhxthmLayout(Context context) {
        this(context, null);
    }

    public RhxthmLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    public void setAdapter(RhxthmAdapter adapter) {
    ...
    */
    ...
    private void actionUp() {
        ...
        AppService.getsBus().post(new RhxthmEvent(mCurrentItemPosition));
        mCurrentItemPosition = -1;
