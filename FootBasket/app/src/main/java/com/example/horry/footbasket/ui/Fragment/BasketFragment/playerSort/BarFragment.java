...
public class BarFragment extends BaseFragment {
    ...
    public void produceOne(ChartView chart, Runnable action){
        ...
        AnimatorUtil.showCardBackgroundColorAnimation(mCardItem, preClor, currentColor, 400);
        ...
        Tooltip tooltip = new Tooltip(getActivity(), R.layout.barchart_onetool);
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
    ...
    private void showTooltipOne(){
        ...
        for(int i = 0; i < areas.size(); i++) {
            ...
            Tooltip tooltip = new Tooltip(getActivity(), R.layout.barchart_onetool, R.id.value);
