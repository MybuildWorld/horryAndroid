...
public class RhxthmAdapter extends BaseAdapter{
    ...
    public RhxthmAdapter(Context context, int[] colorList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        RelativeLayout relativeLayout = (RelativeLayout) this.mInflater.inflate(R.layout.rhxthm_adapter, null);
