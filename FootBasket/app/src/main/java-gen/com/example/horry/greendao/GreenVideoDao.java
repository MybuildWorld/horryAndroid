...
public class GreenVideoDao extends AbstractDao<GreenVideo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Videoentity = new Property(1, String.class, "videoentity", false, "VIDEOENTITY");
        public final static Property Kindtype = new Property(2, String.class, "kindtype", false, "KINDTYPE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GREEN_VIDEO\" (" + //
                ...
                "\"VIDEOENTITY\" TEXT," + // 1: videoentity
                "\"KINDTYPE\" TEXT);"); // 2: kindtype
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GreenVideo entity) {
        ...
        String videoentity = entity.getVideoentity();
        if (videoentity != null) {
            stmt.bindString(2, videoentity);
        }
 
        String kindtype = entity.getKindtype();
        if (kindtype != null) {
            stmt.bindString(3, kindtype);
        }
    }
    ...
    public GreenVideo readEntity(Cursor cursor, int offset) {
        GreenVideo entity = new GreenVideo( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // videoentity
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // kindtype
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GreenVideo entity, int offset) {
        ...
        entity.setVideoentity(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setKindtype(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
